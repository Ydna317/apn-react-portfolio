        ...
        <div>
            <div className="uk-tile headingText uk-text-left" uk-height-viewport="expand: true">
                <div className="greeting">
                    ...
                    <animated.div style={propsName} className="name">Andy<span>.</span></animated.div>
                </div>
                <animated.p style={propsSub} className="subHeading">Full Stack Web Developer</animated.p>
